...
extension AppDelegate {
  ...
  private func createDragLine(sender: NSPanGestureRecognizer) {
          ...
          // Create a new window
          dragLineWindow = NSWindow(contentRect: screen.frame, styleMask: .borderless, backing: .buffered, defer: false)
  ...
  private func updateDragLine(sender: NSPanGestureRecognizer) {
      guard let lineView = dragLineView, let _ = NSScreen.main, let button = sender.view as? NSStatusBarButton else { return }
